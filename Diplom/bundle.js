...
var _KidsParty = __webpack_require__(28);
...
var _OrderButton = __webpack_require__(32);
...
var KidsParty = function (_React$PureComponent) {
  ...
  function KidsParty() {
    ...
    }, _this.selectedCategory = function (id) {
      _this.setState({ selectedCategoryId: id, viewMode: 1 }, console.log('выбрана категория ' + _this.state.selectedCategoryId));
  ...
  _createClass(KidsParty, [{
    ...
    value: function render() {
      ...
      var mainMenu = this.props.category.map(function (v) {
        return _react2.default.createElement(_MenuButton2.default, { yourCategory: v, key: v.id, id: v.id,
...
var MenuButton = function (_React$PureComponent) {
    ...
    function MenuButton() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MenuButton.__proto__ || Object.getPrototypeOf(MenuButton)).call.apply(_ref, [this].concat(args))), _this), _this.selected = function (EO) {
            _this.props.cbSelectedCategory(_this.props.id);
            console.log('передаем родителю свой id' + _this.props.id);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
